...
const ReportForm: React.FC = () => {
  ...
  const getInputClass = (fieldName: string) => `w-full input-field ${errors[fieldName] ? 'border-red-500 focus:ring-red-200' : ''}`;
        ...
        <div className="space-y-4">
          ...
          <div className="grid grid-cols-2 gap-4">
            <div>
              ...
              {errors.date && <p className="text-xs text-red-500 mt-1 flex items-center"><AlertCircle className="w-3 h-3 mr-1"/>{errors.date}</p>}
            </div>
            <div>
              <label className="block text-sm font-medium text-slate-700 mb-1">📂 Nº OM <span className="text-red-500">*</span></label>
              <input 
                type="number" 
                placeholder="12345" 
              ...
              />
              {errors.omNumber && <p className="text-xs text-red-500 mt-1 flex items-center"><AlertCircle className="w-3 h-3 mr-1"/>{errors.omNumber}</p>}
            </div>
          </div>

          <div>
             <label className="block text-sm font-medium text-slate-700 mb-1">🚜 Equipamento <span className="text-red-500">*</span></label>
             ...
             {errors.equipment && <p className="text-xs text-red-500 mt-1 flex items-center"><AlertCircle className="w-3 h-3 mr-1"/>{errors.equipment}</p>}
          </div>
          ...
          <div className="grid grid-cols-2 gap-4">
            <div>
              <label className="block text-sm font-medium text-slate-700 mb-1">⏰ Horário Inicial <span className="text-red-500">*</span></label>
              ...
              {errors.startTime && <p className="text-xs text-red-500 mt-1 flex items-center"><AlertCircle className="w-3 h-3 mr-1"/>{errors.startTime}</p>}
            </div>
             <div>
              <label className="block text-sm font-medium text-slate-700 mb-1">⏰ Horário Final <span className="text-red-500">*</span></label>
              <input type="time" value={formData.endTime || ''} onChange={e => handleChange('endTime', e.target.value)} className={getInputClass('endTime')} />
              {errors.endTime && <p className="text-xs text-red-500 mt-1 flex items-center"><AlertCircle className="w-3 h-3 mr-1"/>{errors.endTime}</p>}
            </div>
          </div>
          ...
          <div className="bg-white p-4 rounded-xl border border-slate-200 shadow-sm">
             ...
             {formData.iamoDeviation && (
                 <div className="space-y-3 mt-3 pt-3 border-t border-slate-100 animate-fadeIn">
                     <div>
                        ...
                        />
                        {errors.iamoPeriod && <p className="text-xs text-red-500 mt-1 flex items-center"><AlertCircle className="w-3 h-3 mr-1"/>{errors.iamoPeriod}</p>}
                     </div>
                     <div>
                        <textarea 
                            ...
                            rows={2}
                        />
                        {errors.iamoReason && <p className="text-xs text-red-500 mt-1 flex items-center"><AlertCircle className="w-3 h-3 mr-1"/>{errors.iamoReason}</p>}
                     </div>
                 </div>
             )}
          </div>
                    ...
                    {formData.hasPending && (
                       <div className="mt-3 pt-2 border-t border-slate-100 animate-fadeIn">
                           <textarea 
                              ...
                              rows={2}
                           />
                           {errors.pendingDescription && <p className="text-xs text-red-500 mt-1 flex items-center"><AlertCircle className="w-3 h-3 mr-1"/>{errors.pendingDescription}</p>}
                       </div>
                   )}
                </div>
           </div>
           ...
           <div>
              <label className="block text-sm font-medium text-slate-700 mb-1">📈 Equipe (Turno) <span className="text-red-500">*</span></label>
              <select value={formData.team} onChange={e => handleChange('team', e.target.value)} className={getInputClass('team')}>
                  <option value="">Selecione...</option>
                  {TEAMS.map(t => <option key={t} value={t}>{t}</option>)}
              </select>
              {errors.team && <p className="text-xs text-red-500 mt-1 flex items-center"><AlertCircle className="w-3 h-3 mr-1"/>{errors.team}</p>}
           </div>

           <div>
              <label className="block text-sm font-medium text-slate-700 mb-1">🔖 Centro de Trabalho <span className="text-red-500">*</span></label>
              ...
              {errors.workCenter && <p className="text-xs text-red-500 mt-1 flex items-center"><AlertCircle className="w-3 h-3 mr-1"/>{errors.workCenter}</p>}
           </div>

           <div>
              <label className="block text-sm font-medium text-slate-700 mb-1">👥 Técnicos <span className="text-red-500">*</span></label>
              <textarea 
                ...
                rows={3}
              />
              {errors.technicians && <p className="text-xs text-red-500 mt-1 flex items-center"><AlertCircle className="w-3 h-3 mr-1"/>{errors.technicians}</p>}
           </div>
